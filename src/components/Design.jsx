  ...
  return (
    <section id="design" className="py-20 bg-gradient-to-br from-purple-900/70 via-pink-900/60 to-indigo-900/80 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <h2 className={`text-4xl font-bold text-center mb-4 text-white group cursor-pointer transition-all duration-700 hover:text-pink-300 hover:scale-110 relative transform ${isVisible ? 'animate-fade-in' : 'opacity-0 translate-y-10'}`}>
        ...
        <p className={`text-center text-purple-200 mb-16 text-lg max-w-2xl mx-auto transition-all duration-700 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
            ...
            >
              ...
              {work.badge && (
                <div className="absolute top-6 right-6 z-20">
                  <div className="px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white text-xs font-bold rounded-full shadow-lg animate-pulse">
                    {work.badge}
                  </div>
                </div>
              )}
              ...
              {/* Icon */}
              <div className="absolute top-6 left-6 z-20 text-4xl transform group-hover:scale-125 group-hover:rotate-12 transition-all duration-500">
                {work.icon}
              </div>
              
              <div className="p-8 pt-16 relative overflow-hidden">
                ...
                <div className="mb-6 relative z-10">
                  ...
                  <p className="text-purple-600 font-medium group-hover:text-pink-700 transition-colors duration-300">{work.category}</p>
                </div>
                ...
                <div className="flex gap-4 relative z-10 flex-wrap">
                  <a href={work.viewLink} target="_blank" rel="noopener noreferrer">
                    <button className="px-6 py-2 bg-primary text-primary-foreground rounded-lg hover:scale-110 hover:shadow-lg transition-all duration-500 btn-pulse hover-glow group-hover:bg-purple-600">
                  ...
                  {work.linkedinLink && (
                    <a href={work.linkedinLink} target="_blank" rel="noopener noreferrer">
                      <button className="px-6 py-2 border border-border rounded-lg hover:bg-accent hover:scale-110 hover:shadow-lg transition-all duration-500 card-hover group-hover:border-purple-300">
                        LinkedIn Post
                      </button>
                    </a>
                  )}
